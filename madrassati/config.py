...
class Config:
    ...
    MAILJET_API_KEY = os.getenv(
        "MAILJET_API_KEY", "b19bb27f7b9468e24bbc507887e40117"
    )  # Replace with your Mailjet API key
    MAILJET_SECRET_KEY = os.getenv(
        "MAILJET_SECRET_KEY", "79cb686958740c387b9fafd9f04d8c93"
    )  # Replace with your Mailjet secret key
    # Default sender email address (verified in your Mailjet account)
    MAIL_SENDER = os.environ.get("MAIL_SENDER", "dirassati@outlook.com")
